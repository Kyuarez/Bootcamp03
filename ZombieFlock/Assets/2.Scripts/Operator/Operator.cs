...
public class Operator : MonoSingleton<Operator>
{
    ...
    protected override void Awake()
    {
        ...
        Quest chapter0_quest1 = new Quest(1, "[AK-47 먹기]", "AK-47 1회 먹기", chapter0_conditionList1);
        Quest chapter0_quest2 = new Quest(2, "[좀비 죽이기]", "일반 좀비 1마리 죽이기", chapter0_conditionList2);
        ...
        Quest quest2 = new Quest(2, "[좀비 죽이기]", "일반 좀비 10마리 죽이기", chapter01_conditionList2);
